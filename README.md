...
This project shows the implementation of Medallion Architecture, organizing data into three distinct layers to ensure quality and reliability:

### 🥉Bronze Layer (Raw): 
Ingests raw data from source systems (ERP and CRM) provided as CSV files. This layer uses Batch Processing with a Truncate & Insert strategy, keeping the data "as-is" without any initial transformation.

### 🥈Silver Layer (Cleansed): 
Focuses on Data Cleaning, Standardizing, and Normalizing. It resolves data quality issues and derives necessary columns to prepare the data for integration.
